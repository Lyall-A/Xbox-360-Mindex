...
To run, have Node.js and FFmpeg installed and run `node .` with all your songs in the `songs` directory, then place the mindex directory onto the root of your Xbox 360's HDD
